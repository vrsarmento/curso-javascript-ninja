(function() {
	...
	*/
	...
	console.log( text.replace( /Manuel Marques de Sousa/g, 'Victor Rocha' ) );
	...
	*/
	...
	console.log( text.replace( /brasileiro/g, 'cataguasense' ) );
	...
	*/
	...
	function replaceDate(){
		var result = text.replace( regexDate, function(all, $1, $2, $3){
	...
	//Ideal - função à parte
	function replaceDate2(regex, day, month, year){
